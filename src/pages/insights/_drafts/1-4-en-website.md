...
## 1.4 (EN) | ERP Scope Creep: When the Project Grows Faster Than the Budget

### SEO — English

| Field | Content |
|---|---|
| Primary keyword | ERP scope creep |
| Secondary keywords | ERP project scope management, controlling ERP requirements, ERP budget overrun, ERP project management |
| URL slug | `/erp-scope-creep` |
| SEO title | ERP Scope Creep: Why Your Project Keeps Growing — and How to Control It |
| Meta description | Scope creep is one of the most common reasons ERP projects go over budget and timeline. Learn how it happens and what to put in place before kick-off. |
| H1 | ERP Scope Creep: When the Project Grows Faster Than the Budget |
