...
slug: "workflow-thong-minh-the-he-moi"
language: "vi"
...
draft: true
seo:
  title: "Workflow thế hệ mới — khi AI và organizational knowledge thay đổi cách công việc được thực hiện"
  ...
  searchIntent: "Informational — COO/Operations đang tìm cách cải thiện workflow hiện tại"
cta:
  primary: "Workflow Readiness Assessment"
  secondary: "Đọc bài liên quan trong cluster Workflow"
relatedInternalLinks:
  - "workflow-readiness-assessment"
  - "cluster-5-supporting-articles"
  - "ai-agent-trong-workflow" # bài 6.13 (đề xuất)
  - "ai-agent-trong-doanh-nghiep" # bài 2.6
  - "process-readiness-truoc-erp" # bài 1.2
evidenceSources:
