...
slug: "kiem-soat-ai-doanh-nghiep"
language: "vi"
...
seo:
  ...
  secondaryKeywords:
    ...
    - "AI được phép làm gì"
  searchIntent: "Informational — CIO/CEO đang lo ngại về việc AI agent có thể làm những gì không mong muốn"
cta:
...
relatedInternalLinks:
  ...
  - "ai-agent-trong-doanh-nghiep" # bài 2.6
  - "ai-agent-va-workflow" # bài 5.13
  - "evidence-based-ai" # bài 2.7
evidenceSources:
  - "Replit AI coding agent — sự cố xóa database production, tháng 7/2025 (xác nhận công khai bởi CEO Replit, đưa tin bởi Business Insider, The Register, eWeek)"
