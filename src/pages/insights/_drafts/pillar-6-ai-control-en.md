...
language: "en"
translationKey: "pillar-6-ai-control-layer"
type: "pillar"
cluster: "ai-control"
...
draft: true
seo:
  title: "How Far Should AI Be Allowed to Go — and Why Enterprises Need a Control Layer"
  ...
  secondaryKeywords:
    ...
    - "AI agent oversight"
  searchIntent: "Informational — CIOs and executives concerned about what AI agents might do without proper controls"
cta:
  primary: "AI Readiness Assessment"
  secondary: "Contact OKELAS"
relatedInternalLinks:
  - "ai-readiness-assessment"
  - "cluster-6-supporting-articles"
  - "ai-agents-in-business" # article 2.6
  - "ai-agent-and-workflow" # article 5.13
  - "evidence-based-ai" # article 2.7
evidenceSources:
  - "Replit AI coding agent — production database deletion incident, July 2025 (publicly confirmed by Replit's CEO, reported by Business Insider, The Register, eWeek)"
